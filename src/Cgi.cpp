...
//// #include <sys/wait.h>
//// #include <cstdlib>
//// void    Cgi::executeCgi() { // std::string //
...
////             int outputFd = open("../www/scriptLog.html", O_WRONLY | O_CREAT | O_TRUNC, 0644);
////             if (outputFd == -1) { //500 error
////                 std::cout << "open" << std::endl;
////                 exit(2);
////             }
//
////             int dup2Result = dup2(outputFd, STDOUT_FILENO);
////             if (dup2Result == -1) { // 500 error
